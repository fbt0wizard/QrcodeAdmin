  ...
  return (
    <div style={{ height: "100%", width: "100%" }}>
      ...
      >
        ...
        >
          QR CODES Available for {pickedProduct[0].name} <CircularProgress sx={{width: "40px"}} color="inherit" />
        </Typography>
      </Box>
        ...
        <Box>
          ...
          <ReactToPrint
            ...
            trigger={() => {
              return (
                <Button
                  disabled={i === validqr.length ? false : true}
                  type="button"
                  variant="contained"
                  sx={{
                    m: 2,
