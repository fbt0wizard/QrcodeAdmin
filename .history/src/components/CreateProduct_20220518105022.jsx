...
import { Box, Typography, Button, Divider, Input, IconButton } from "@mui/material";
...
export default function CreateProduct({ picked, setModal }) {
  ...
  <IconButton color="primary" aria-label="upload picture" component="span">
    <PhotoCamera />
        ...
        {/* <button type="button" onClick={() => img.current.click()}> upload</button>
        <input style={{display: "none"}} type="file" name="images" ref={img}/> */}
