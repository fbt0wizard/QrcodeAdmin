    ...
    <React.Fragment>
      <Box sx={{ width: "100%" }}>
        ...
        >
          <Box
            component="div"
            sx={{ width: "97%", overflowX: "scroll", m: "auto" }}
          >
            <Table size="small" sx={{ width: "100%", borderCollapse: "collapse", minWidth: 1000,  mb: 1 }}>
              <TableHead>
                <TableRow>
                  <TableCell>#</TableCell>
          ...
          {!pending && paginate.totalPage !== 1 && (
            <div>
              <Pagination
                ...
                shape="rounded"
              />
              <Typography variant="body1" sx={{ pl: "3px", fontSize: 13, mt: 1 }}>
