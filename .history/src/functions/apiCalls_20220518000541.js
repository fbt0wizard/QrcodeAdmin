...
export const post = async (data, endpoint, file=false) => {
  ...
  try {
    const res = await fetch(`${baseUrl}${endpoint}`, {
      ...
      processData: file ? false : null,
      cache: file ? false : null
    });
...
export const axiosPost = async (endpoint, data = {}, empty = false) => {
  ...
  return axios({
    ...
    headers: {
      // Accept: "application/json",
      'goh-access-token': 'QShFN8DrPWLGNsJpkHhMHVWcw8eGqPcnfxDgMUL39MIfAGW6pTN8xKn4zRMWLw3r.IntcInV1aWRcIjpcInVzci05OTcyMTg2MC1jMzUyLTExZWMtOGM1Ny0zMTE1MjM5MWViZWZcIixcImVtYWlsXCI6XCJhZG1pblwifS4uWzRdantJelBDQ21JPVVSPURYN2JEdmRhSDJuQ2xoWm5EdnVXNEprRjQxNTdBbHJQIz0pa3pscHB2dUFCalB1ai4uMjAyMy0wNS0xNyAxODoyODowMCI=',
      Platform: "admin/0.1.0",
  },
    cache: false,
    //  dataType: 'JSON',
